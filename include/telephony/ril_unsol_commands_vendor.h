...
*/
    ...
    {RIL_UNSOL_RINGBACK_TONE_STATE, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_FACTORY_AM, responseVoid, WAKE_PARTIAL},
    ...
    // RIL_UNSOL_UICC_SUBSCRIPTION_STATUS_CHANGED redefined, see ril_unsol_commands.h
    ...
    {RIL_UNSOL_CP_POSITION, responseVoid, WAKE_PARTIAL},
    ...
    {RIL_UNSOL_CDMA_SIP_REG_NOTI, responseVoid, WAKE_PARTIAL},
